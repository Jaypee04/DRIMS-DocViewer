<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LogIN.aspx.vb" Inherits="LogIN" title="Document Viewer" %>
    ...
    <table style="margin: 0 auto; padding-top:130px" border="0">
        ...
        <tr><td style="">
            	<table bgcolor="#f1f1f1" style="margin-top:30px; width:600px;" border="0">                      	
                    ...
                    <tr><td>&nbsp;</td>
                  		<td>&nbsp;</td>
                  		<td rowspan="4" style="width:400px; border: #666666 1px dotted; padding:15px 5px 15px 25px;"><p>The <strong>Document Viewer</strong> provides a facility to add, update and browse documents that are significant to the agency.</p>
                  	  <p>Login to <a href="http://192.168.8.16/rectrack/">Record Tracker</a>.</p></td></tr>
